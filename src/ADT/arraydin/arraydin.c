...
//     if ((*DT).Neff < (*DT).Capacity)
//     {
//         (*DT).Dinner_temp[(*DT).Neff].Id = (*Dinner).Din[idx].ID;
//         (*DT).Dinner_temp[(*DT).Neff].durasi = (*Dinner).Din[idx].Durasi;
//         (*DT).Dinner_temp[(*DT).Neff].ketahanan = (*Dinner).Din[idx].Ketahanan;
//         (*DT).Dinner_temp[(*DT).Neff].HaRga = (*Dinner).Din[idx].Harga;
//         (*DT).Neff += 1;
//     }
// }
